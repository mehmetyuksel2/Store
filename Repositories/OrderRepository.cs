...
namespace Repositories
{
    public class OrderRepository : RepositoryBase<Order>, IOrderRepository
    {
        ...
        public IQueryable<Order> Orders => _context.Orders.Include(o => o.Lines)
            .ThenInclude(cl => cl.Product).OrderBy(o => o.Shipped)
            .ThenByDescending(o => o.OrderId);//sipariş özelindeki ürünleri gönderilip
                                    // gönderilmediğini ve id sıralaması yaparak çeker
